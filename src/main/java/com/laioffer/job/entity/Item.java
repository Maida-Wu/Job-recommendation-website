...
public class Item {
    ...
    public boolean equals(Object o) {
        ...
        return favorite == item.favorite &&
                ...
                companyLogo.equals(item.companyLogo) &&
                url.equals(item.url) &&
                description.equals(item.description) &&
                keywords.equals(item.keywords) &&
                name.equals(item.name);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, title, location, companyLogo, url, description, keywords, name, favorite);
    }
