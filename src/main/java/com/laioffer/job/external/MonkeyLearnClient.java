...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "03c643d49ffc613e7417f80f7a45db34419c6aa6";

    public List<Set<String>> extract(List<String> articles) throws JsonProcessingException {
